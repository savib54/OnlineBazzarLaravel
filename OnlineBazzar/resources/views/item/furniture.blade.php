...
<div class="row">
  <div class="col-1.">
    <div class="list-group" id="list-tab" role="tablist">
      ...
      <a class="list-group-item list-group-item-action active" id="list-furniture-list" data-toggle="list" href="{{ route('furniture') }}" role="tab" >Furniture</a>
