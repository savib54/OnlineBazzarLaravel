...
<select class="category"  value="$data['category']" name="category">
  ...
  <div class="form-group col-md-6 col-md-offset-6">
    ...
    <input type="text" class="form-control" name="product_name" value="<?php $data->product_name ?>" placeholder="Product name">
  </div>
  ...
  <div class="form-group col-md-6 col-md-offset-6">
    ...
    <textarea  class="form-control" name="detail" value="$data['detail']" placeholder="Detail"></textarea>
  </div>
  <div class="form-group col-md-6 col-md-offset-6">
  ...
  <div class="form-group col-md-6 col-md-offset-6">
    ...
    <input type="file" class="form-control" name="upload" id="upload" value="$data['upload']" placeholder="upload">
  </div>
  <div class="form-group col-md-6 col-md-offset-6">
